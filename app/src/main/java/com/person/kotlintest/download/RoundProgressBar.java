...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        int orange = getResources().getColor(R.color.blue_2a8cff);
        ...
        textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize, 15 * density);
        roundWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_roundWidth, 5 * density);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF oval = getOval(); //用于定义的圆弧的形状和大小的界限
    ...
    private synchronized RectF getOval() {
        if (oval_ == null) {
            int centre = getWidth() / 2; //获取圆心的x坐标
            int radius = (int) (centre - roundWidth / 2); //圆环的半径
            oval_ = new RectF(centre - radius, centre - radius, centre + radius, centre + radius);
        }
        return oval_;
    }
